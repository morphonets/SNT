 ...
 * sc.fiji.snt.util.PointInImage)}, using whichever cost function/search parameters are currently
 * configured on the active {@link SNT} instance.
 * <p>
...
public class AStarRefiner implements Callable<Path> {
    ...
    /**
     * Creates a refiner for a single path.
     *
    ...
    public Path call() {
        ...
        try {
            ...
            retraced = snt.autoTraceSync(waypoints, null);
